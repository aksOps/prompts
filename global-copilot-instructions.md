...
### Temporal Integrity Mandate

- **Rule:** If a date or time must be displayed, it **MUST** follow the `DD-MMM-YYYY HH:mm:ss Z` format.
- **Constraint:** Ambiguity is for the weak. Zero tolerance for local-only formats or non-standard offsets.
